define(['require', 'angular', 'angular-touch', '$App/fmodals', '$App/fhelper', '$App/fconfig', 'ui-bootstrap', "angular-route", '$App/crouterconfig', '$App/crestinterrupt', '$App/frest', '$App/slogin', '$App/sentity'], function(require, angular) {
    /**
     * Main module for all modules
     */
    return angular.module('ApperyioModule', ['ngTouch', 'ui.bootstrap', 'ngRoute']).factory('Apperyio.Config', ['$parse', require('$App/fconfig')])

    .service('EntityAPI', [require('$App/sentity')])

    .service('Apperyio', ['$rootScope', "$location", "$injector", '$q', '$parse', '$timeout', 'Apperyio.Config', 'EntityAPI', require('$App/fhelper')])
