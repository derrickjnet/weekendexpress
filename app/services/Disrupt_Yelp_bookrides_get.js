/**
 * Module initializes rest service Disrupt_Yelp_bookrides_get
 */
...
define(['require'], function(require) {
    ...
    return [{
        type: 'service',
        name: 'Disrupt_Yelp_bookrides_get',
        deps: ['Apperyio', 'REST', Disrupt_Yelp_bookrides_getImpl]
    }];

    /**
     * @function Disrupt_Yelp_bookrides_getImpl
     */

    function Disrupt_Yelp_bookrides_getImpl(Apperyio, REST) {
...
/**
        ...
        this.config = {
            url: "https://api.appery.io/rest/1/apiexpress/api/Yelp/bookrides",
            method: "get",
            headers: Apperyio.EntityAPI("Disrupt_Yelp_bookrides_get.request.headers"),
            params: Apperyio.EntityAPI("Disrupt_Yelp_bookrides_get.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "Disrupt_Yelp_bookrides_get"
            }
        };
